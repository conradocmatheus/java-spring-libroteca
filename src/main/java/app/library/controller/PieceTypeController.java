...
public class PieceTypeController {
    ...
    @PostMapping("/save")
    public ResponseEntity<?> save(@Valid @RequestBody PieceType pieceType) {
        try {
    ...
    public ResponseEntity<?> update(@Valid @PathVariable Long id, @RequestBody PieceType pieceType) {
        try {
