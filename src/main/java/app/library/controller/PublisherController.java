...
public class PublisherController {
    ...
    @PostMapping("/save")
    public ResponseEntity<?> save(@Valid @RequestBody Publisher publisher) {
        try {
    ...
    public ResponseEntity<?> update(@Valid @PathVariable Long id, @RequestBody Publisher publisher) {
        try {
